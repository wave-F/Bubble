...
const MESSAGES = {
  zh: {
    ...
    "editor.label.winMode": "过关方式",
    "editor.winMode.unify": "统一颜色",
    "editor.winMode.retain": "分拣目标（保留数量）",
    "editor.section.retainTargets": "分拣目标",
    "editor.retainTargets.hint": "填写需要留在场上的泡泡数量（0 表示不要求该颜色）。",
    "editor.solve.retainNotFound": "最优解：未找到（40 步内达不到分拣目标）",
    "editor.solve.retainZero": "最优解：0 步（开局已满足分拣目标）",
    "editor.retainValidate.emptyTargets": "分拣目标：请至少指定一种颜色的保留数量",
    "editor.retainValidate.targetsTooMany": "分拣目标：保留总数 {{sum}} 超过棋盘格数 {{cells}}",
    "editor.retainValidate.missingColor": "分拣目标：初始棋盘没有「{{name}}」",
    "editor.retainValidate.warnAllCells": "提示：保留总数等于棋盘格数（无需捏碎即可过关）",
    "editor.retainValidate.warnAlreadyWon": "提示：开局已满足分拣目标",
    ...
    "playtest.status.winRetain": "过关！场上数量已与分拣目标一致",
    "playtest.status.lose": "失败：步数用尽，颜色未统一",
    "playtest.status.loseRetain": "失败：步数用尽，未达到分拣目标",
  ...
  en: {
    ...
    "editor.label.winMode": "Win condition",
    "editor.winMode.unify": "Unify one color",
    "editor.winMode.retain": "Sorting targets (retain counts)",
    "editor.section.retainTargets": "Sorting targets",
    "editor.retainTargets.hint": "Bubbles that must remain on the board (0 = not required).",
    "editor.solve.retainNotFound": "Optimal: no solution within 40 moves for sorting targets",
    "editor.solve.retainZero": "Optimal: 0 moves (sorting targets already met)",
    "editor.retainValidate.emptyTargets": "Sorting targets: set at least one color count",
    "editor.retainValidate.targetsTooMany": "Sorting targets: retain sum {{sum}} exceeds grid cells {{cells}}",
    "editor.retainValidate.missingColor": "Sorting targets: no \"{{name}}\" on the initial board",
    "editor.retainValidate.warnAllCells": "Note: retain sum equals grid size (win without pops)",
    "editor.retainValidate.warnAlreadyWon": "Note: sorting targets already met at start",
    ...
    "playtest.status.winRetain": "Cleared! Board matches sorting targets",
    "playtest.status.lose": "Failed: out of moves, colors differ",
    "playtest.status.loseRetain": "Failed: out of moves, targets not met",
